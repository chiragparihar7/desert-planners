...
export default function SectionManagement() {
  ...
  const handleAddOrUpdateItem = async (e) => {
    ...
    try {
      ...
      // 👇 image file append karna zaroori hai
      ...
      if (editItem) {
        await api.put(
          `${API.UPDATE_SECTION_ITEM(selectedSection._id, editItem._id)}`,
          formData,
        ...
        await api.post(
          `${API.ADD_SECTION_ITEM(selectedSection._id)}`,
          formData,
          {
            headers: { "Content-Type": "multipart/form-data" },
          }
                ...
                >
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full border border-gray-300 rounded-xl px-4 py-2 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
                      required={!editItem}
                    />
                    {editItem &&
                      newItem.img &&
                      typeof newItem.img === "string" && (
                        <img
                          src={newItem.img}
                          alt="Current"
                          className="mt-2 w-24 h-16 object-cover rounded-lg border"
                        />
                      )}
                  </div>
